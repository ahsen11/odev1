...
yaşYiğit=2024-ogrenci1[2]
yaşAda=2024-ogrenci2[2]
yaşÇınar=2024-ogrenci3[2]

# 11- Öğrencilerin not ortalamalarını hesaplayınız.
ortalamaYiğit=(ogrenci1[3][0]+ogrenci1[3][1]+ogrenci1[3][2])/3
ortalamaAda=(ogrenci2[3][0]+ogrenci2[3][1]+ogrenci2[3][2])/3
ortalamaÇınar=(ogrenci3[3][0]+ogrenci3[3][1]+ogrenci3[3][2])/3
